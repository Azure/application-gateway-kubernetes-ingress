...
.. note::
    ...
    Details on cookie based affinity for Application Gateway for Containers [may be found here](https://learn.microsoft.com/azure/application-gateway/for-containers/session-affinity?tabs=session-affinity-gateway-api).
