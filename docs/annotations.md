...
| [appgw.ingress.kubernetes.io/rule-priority](#rule-priority) | `int32` | `nil` |   | `1.7.0-rc1` | 
...
## Rule Priority
This annotation sets the priority of the rule. This applies to all the rules in the ingress resource.

### Usage

```yaml
appgw.ingress.kubernetes.io/rule-priority: "200"
```
