...
- [Multi-cluster / Shared App Gateway](#): Install AGIC in an environment, where App Gateway is
...
### Example Scenario
Let's take an imaginary App Gateway, which manages traffic for 2 web sites:
  - prod.contoso.com
  - dev.contoso.com
