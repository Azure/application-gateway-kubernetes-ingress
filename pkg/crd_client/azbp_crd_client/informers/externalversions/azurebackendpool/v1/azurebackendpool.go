...
import (
	...
	versioned "github.com/Azure/application-gateway-kubernetes-ingress/pkg/crd_client/azbp_crd_client/clientset/versioned"
	internalinterfaces "github.com/Azure/application-gateway-kubernetes-ingress/pkg/crd_client/azbp_crd_client/informers/externalversions/internalinterfaces"
	v1 "github.com/Azure/application-gateway-kubernetes-ingress/pkg/crd_client/azbp_crd_client/listers/azurebackendpool/v1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurebackendpoolsV1().AzureBackendPools(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurebackendpoolsV1().AzureBackendPools(namespace).Watch(options)
			},
		},
