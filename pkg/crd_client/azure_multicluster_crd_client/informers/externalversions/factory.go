...
import (
	...
	globalservice "github.com/Azure/application-gateway-kubernetes-ingress/pkg/crd_client/azure_multicluster_crd_client/informers/externalversions/globalservice"
...
type SharedInformerFactory interface {
	...
	Azureglobalservices() globalservice.Interface
	Multiclusteringresses() multiclusteringress.Interface
}

func (f *sharedInformerFactory) Azureglobalservices() globalservice.Interface {
	return globalservice.New(f, f.namespace, f.tweakListOptions)
}
