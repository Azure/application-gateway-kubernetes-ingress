...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=azureglobalservices.networking.aks.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("globalservices"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Azureglobalservices().V1alpha1().GlobalServices().Informer()}, nil

		// Group=multiclusteringresses.networking.aks.io, Version=v1alpha1
	case multiclusteringressv1alpha1.SchemeGroupVersion.WithResource("multiclusteringresses"):
