...
import (
	...
	v1alpha1 "github.com/Azure/application-gateway-kubernetes-ingress/pkg/crd_client/azure_multicluster_crd_client/listers/multiclusteringress/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MulticlusteringressesV1alpha1().MultiClusterIngresses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MulticlusteringressesV1alpha1().MultiClusterIngresses(namespace).Watch(context.TODO(), options)
			},
		},
		&multiclusteringressv1alpha1.MultiClusterIngress{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiClusterIngressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&multiclusteringressv1alpha1.MultiClusterIngress{}, f.defaultInformer)
}
