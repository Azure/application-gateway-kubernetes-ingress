...
type FakeAzureIngressProhibitedTargets struct {
	Fake *FakeAzureingressprohibitedtargetsV1
	ns   string
}
...
func (c *FakeAzureIngressProhibitedTargets) Get(name string, options v1.GetOptions) (result *azureingressprohibitedtargetv1.AzureIngressProhibitedTarget, err error) {
	...
	return obj.(*azureingressprohibitedtargetv1.AzureIngressProhibitedTarget), err
}
...
func (c *FakeAzureIngressProhibitedTargets) List(opts v1.ListOptions) (result *azureingressprohibitedtargetv1.AzureIngressProhibitedTargetList, err error) {
	...
	list := &azureingressprohibitedtargetv1.AzureIngressProhibitedTargetList{ListMeta: obj.(*azureingressprohibitedtargetv1.AzureIngressProhibitedTargetList).ListMeta}
	for _, item := range obj.(*azureingressprohibitedtargetv1.AzureIngressProhibitedTargetList).Items {
