...
const (
	...
	MutliClusterModeVarName = "MULTICLUSTER_MODE"
)
...
func GetEnv() EnvVariables {
	...
	MutliClusterMode, _ := strconv.ParseBool(os.Getenv(MutliClusterModeVarName))
	...
	env := EnvVariables{
		...
		MutliClusterMode:            MutliClusterMode,
	}
